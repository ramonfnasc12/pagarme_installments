LoadCheckoutPaymentContext(function (Checkout, PaymentOptions) {
    ...
    const PagarmeCreditCardPayment = new PaymentOptions.Transparent.CardPayment({
        ...
        onLoad: Checkout.utils.throttle(async function (callback) {
            installments = [{ "quantity": 1, "interestFree": false, "installmentAmount": currentCheckoutTotalPrice, "totalAmount": interest * currentCheckoutTotalPrice }, { "quantity": 2, "interestFree": false, "installmentAmount": currentCheckoutTotalPrice / 2, "totalAmount": interest * currentCheckoutTotalPrice }, { "quantity": 3, "interestFree": false, "installmentAmount": currentCheckoutTotalPrice / 3, "totalAmount": interest * currentCheckoutTotalPrice }, { "quantity": 4, "interestFree": false, "installmentAmount": currentCheckoutTotalPrice / 4, "totalAmount": interest * currentCheckoutTotalPrice }, { "quantity": 5, "interestFree": false, "installmentAmount": currentCheckoutTotalPrice / 5, "totalAmount": interest * currentCheckoutTotalPrice }, { "quantity": 6, "interestFree": false, "installmentAmount": currentCheckoutTotalPrice / 6, "totalAmount": interest * currentCheckoutTotalPrice }, { "quantity": 7, "interestFree": false, "installmentAmount": currentCheckoutTotalPrice / 7, "totalAmount": interest * currentCheckoutTotalPrice }, { "quantity": 8, "interestFree": false, "installmentAmount": currentCheckoutTotalPrice / 8, "totalAmount": interest * currentCheckoutTotalPrice }, { "quantity": 9, "interestFree": false, "installmentAmount": currentCheckoutTotalPrice / 9, "totalAmount": interest * currentCheckoutTotalPrice }, { "quantity": 10, "interestFree": false, "installmentAmount": currentCheckoutTotalPrice / 10, "totalAmount": interest * currentCheckoutTotalPrice }, { "quantity": 11, "interestFree": false, "installmentAmount": currentCheckoutTotalPrice / 11, "totalAmount": interest * currentCheckoutTotalPrice }, { "quantity": 12, "interestFree": false, "installmentAmount": currentCheckoutTotalPrice / 12, "totalAmount": interest * currentCheckoutTotalPrice }];
            Checkout.setInstallments(installments);
        }),
